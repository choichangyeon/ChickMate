...
const { CREATE_CHARACTER, RESUME_SUBMISSION, INTERVIEW_COMPLETION, FILL_OUT_META_DATA, MOVE_TO_JOB_URL } =
...
export const EXPERIENCE_AMOUNT = {
  ...
  MOVE_TO_JOB_URL_EXP: CHARACTER_HISTORY[MOVE_TO_JOB_URL].amount,
};
